...
public abstract class GuiConsolePanel<T extends Console> extends GuiScreenTileEntity<TileEntityConsoleBase> {
	...
	protected GuiConsolePanel(TileEntityConsoleBase tileEntity, EntityPlayer player, T console) {
		super(tileEntity);
		this.player = player;
	...
	public void drawScreen(int par1, int par2, float par3) {
		if(!(this.tileEntity.isIntact() && this.console.isValid())) {
			this.close();
		}
