 ...
 * Le crochet peut maintenant etre utilise par toute classe qui extends ItemFishingRod.<br />
 * Ensemble : EntityFishHook.
 */
	...
	public void onUpdate() {
		...
		if(this.fishPosRotationIncrements > 0) {
			...
			if(!this.worldObj.isRemote) {
				ItemStack equipedItem = this.angler.getCurrentEquippedItem();
				
				/* ########## ligne suivante modifiee ########## */
				if(this.angler.isDead || !this.angler.isEntityAlive() || equipedItem == null || !(equipedItem.getItem() instanceof ItemFishingRod) || this.getDistanceSqToEntity(this.angler) > 1024.0D) {
					this.setDead();
			...
			if(!this.inGround) {
				...
				for(int var29 = 0; var29 < var27; ++var29) {
					double var14 = this.boundingBox.minY + (this.boundingBox.maxY - this.boundingBox.minY) * (var29 + 0) / var27 - 0.125D + 0.125D;
					double var16 = this.boundingBox.minY + (this.boundingBox.maxY - this.boundingBox.minY) * (var29 + 1) / var27 - 0.125D + 0.125D;
				...
				if(var26 > 0.0D) {
					if(this.ticksCatchable > 0) {
						...
						if(this.rand.nextInt(var28) == 0) {
							...
							for(var15 = 0; var15 < 1.0F + this.width * 20.0F; ++var15) {
								var31 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
								var17 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
								this.worldObj.spawnParticle("bubble", this.posX + var31, var30 + 1.0F, this.posZ + var17, this.motionX, this.motionY - this.rand.nextFloat() * 0.2F, this.motionZ);
							}
	...
	public int catchFish() {
		if(this.worldObj.isRemote) {
			...
			if(this.bobber != null) {
				...
				this.bobber.motionY += var4 * var10 + MathHelper.sqrt_double(var8) * 0.08D;
