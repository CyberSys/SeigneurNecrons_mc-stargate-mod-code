...
public class StargatePacketHandler implements IPacketHandler {
	...
	public static final int packetId_CloseGuiTeleporter = 100;
	public static final int packetId_CloseGuiDhd = 101;
	public static final int packetId_CloseGuiDetector = 102;
	public static final int packetId_CloseGuiMobGenerator = 103;
	public static final int packetId_CloseGuiStuffLevelUpTable = 104;
	...
	static {
		...
		addToMapping(2, TileEntityNaquadahAlloy.class);
		...
		addToMapping(7, TileEntityMobGenerator.class);
	}
