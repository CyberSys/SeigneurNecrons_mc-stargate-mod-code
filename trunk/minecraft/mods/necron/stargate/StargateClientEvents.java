...
public class StargateClientEvents {
	...
	public void loadCustomSounds(SoundLoadEvent event) {
		...
		String[] soundFiles = {"stargate/chevron.wav", "stargate/masterChevron.wav", "stargate/gateOpen.wav", "stargate/gateClose.wav", "stargate/gateFail.wav", "stargate/enterVortex.wav", "stargate/eventHorizon.wav"};
