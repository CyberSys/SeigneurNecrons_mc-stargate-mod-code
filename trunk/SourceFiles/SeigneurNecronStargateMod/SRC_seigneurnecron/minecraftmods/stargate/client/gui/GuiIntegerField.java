...
/**
 * ########## Class copied from GuiTextField and modified (1 added field, 1 modified code part) ##########<br />
 * This text field only accepte integers, with a maximal lenght of 10.<br />
 * Tip '-' will add or remove '-' at the beginning of the line.<br />
...
public class GuiIntegerField extends Gui {
	...
	public GuiIntegerField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
				...
				default:
					switch(key) {
						...
						default:
							...
							else if(numbers.indexOf(character) >= 0 && (this.cursorPosition != 0 || this.text.length() == 0 || this.text.charAt(0) != '-')) {
								this.writeText(Character.toString(character));
								return true;
							}
	 ...
	 */
	private static void drawCursorVertical(int par1, int par2, int par3, int par4) {
		int i1;
