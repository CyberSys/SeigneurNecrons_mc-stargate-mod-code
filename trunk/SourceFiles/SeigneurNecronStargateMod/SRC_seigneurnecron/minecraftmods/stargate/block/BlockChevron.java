...
public class BlockChevron extends BlockStargateSolidPart {
	...
	public void registerIcons(IconRegister iconRegister) {
		for(int i = 1; i <= 9; i++) {
			...
			this.chevronIcon = iconRegister.registerIcon(StargateMod.ASSETS_PREFIX + StargateMod.blockName_chevron);
			this.chevronIcons[i - 1] = iconRegister.registerIcon(StargateMod.ASSETS_PREFIX + this.func_111023_E() + "_" + i);
		}
