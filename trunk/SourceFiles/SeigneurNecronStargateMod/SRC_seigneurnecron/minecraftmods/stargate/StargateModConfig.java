...
public class StargateModConfig {
	...
	@Cfg(comment = "Determines if naquadah blocks can be deleted by right-clicking with a naquadah pickaxe (only if Y != 0).")
	...
	public static synchronized int getBlockId(String blockName) {
	...
	public static synchronized int getItemId(String itemName) {
