 ...
 */
public abstract class BasicContainer<T extends TileEntityContainer> extends Container {
	
	protected T tileEntity;
	
	public BasicContainer(InventoryPlayer inventoryPlayer, T tileEntity) {
