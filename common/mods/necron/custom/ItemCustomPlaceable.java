...
public class ItemCustomPlaceable extends ItemCustom {
	...
	public ItemCustomPlaceable(int id, int iconIdex, String name, CreativeTabs tab, Block block) {
		super(id, iconIdex, name, tab);
		this.BlockId = block.blockID;
		this.succes = false;
	}
	
	public ItemCustomPlaceable(int id, int iconIdex, String name, Block block) {
