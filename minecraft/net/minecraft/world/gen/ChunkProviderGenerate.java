 ...
 * La bedrock est generee uniquement sur la premiere couche (Y = 0).<br />
 * Ensemble : ChunkProviderGenerate.
 */
public class ChunkProviderGenerate implements IChunkProvider {
		...
		for(int var8 = 0; var8 < 16; ++var8) {
			for(int var9 = 0; var9 < 16; ++var9) {
				...
				for(int var16 = 127; var16 >= 0; --var16) {
					...
					if(var16 <= 0/* + this.rand.nextInt(5)*/) { /* ########## ligne modifiee ##########*/
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Pre(par1IChunkProvider, this.worldObj, this.rand, par2, par3, var11));
		...
		if(TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, var11, LAKE) && !var11 && this.rand.nextInt(4) == 0) {
		...
		if(TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, var11, LAVA) && !var11 && this.rand.nextInt(8) == 0) {
			var12 = var4 + this.rand.nextInt(16) + 8;
		...
		boolean doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, var11, DUNGEON);
		...
		doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, var11, ICE);
		...
		MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Post(par1IChunkProvider, this.worldObj, this.rand, par2, par3, var11));
