			...
			switch(character) {
				...
				default:
					switch(key) {
						...
						default:
							if((character == '-' && this.cursorPosition == 0 && (this.text.length() == 0 || this.text.charAt(0) != '-')) || (numbers.indexOf(character) >= 0 && (this.cursorPosition != 0 || this.text.length() == 0 || this.text.charAt(0) != '-'))) {
