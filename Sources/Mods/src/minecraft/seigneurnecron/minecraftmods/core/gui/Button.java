...
public class Button extends GuiButton implements Component {
	 ...
	 * Warning : the button must be added to a {@link Container} using the addComponent(...) method, else the button will have the id 0.
	 ...
	 */
	public Button(Container container, int xPos, int yPos, int width, int height, String text) {
	 ...
	 * @param text - the text displayed on the button.
	 */
	public Button(Container container, int xPos, int yPos, int width, String text) {
		this(container, xPos, yPos, width, Screen.BUTTON_HEIGHT, text);
	}
