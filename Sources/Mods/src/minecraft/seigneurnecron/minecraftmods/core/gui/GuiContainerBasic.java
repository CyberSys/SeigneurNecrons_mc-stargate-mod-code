...
public abstract class GuiContainerBasic<T extends ContainerBasic> extends GuiContainer implements ComponentContainer {
	...
	public void drawDefaultBackground() {
		...
		// Don't draw the background on the whole screen.
	}
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		// WARNING : This method is not in GuiScreenBasic but is equivalent to drawScreen(...).
	...
	protected void initInventory() {
		...
		this.label_container = this.addComponent(new Label(this.panel_container, this.fontRenderer, titleMargin, titleMargin, labelWidth, I18n.func_135053_a(this.container.inventory.getInvName())));
	...
	/**
	 * Adds the buttons, the fields and other controls to the screen. <br />
