...
/**
 * This class is a modified copy of net.minecraft.client.gui.GuiScreenSelectLocation.
...
public abstract class CustomGuiScrollingList {
	...
	protected CustomGuiScrollingList(int left, int top, int width, int height) {
		this.left = left;
		this.top = top;
	 ...
	 * @param doubleClick - whether the element was double clicked or not.
	 */
	 ...
	 * @return true if the element at the given index is selected, else fase.
	 */
	 ...
	 * @param tessellator - the tessellator used to draw.
	 */
	...
	public void registerScrollButtons(int scrollUpActionId, int scrollDownActionId) {
